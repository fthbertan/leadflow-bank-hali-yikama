    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="text-lg sm:text-xl font-extrabold tracking-tight text-white whitespace-nowrap" data-kv="business_name">Bank Halı Yıkama</span>
            </div>
            <p class="text-sm text-white/70 mb-8 leading-relaxed">Sincan Plevne'de kurulu, Ankara'nın güvenilir halı yıkama merkezi. Kapıdan kapıya ücretsiz servis, memnuniyet garantisi.</p>
            <div class="flex gap-4" id="kvSocialLinks">
                ...
                <a href="https://www.tiktok.com/@hayati_bank1?_r=1&_t=ZS-966kPmHot61" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:opacity-80 transition-all" title="TikTok"><svg class="w-5 h-5" viewBox="0 0 24 24" fill="white"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.52a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.43v-7.15a8.16 8.16 0 005.58 2.09V11.1a4.84 4.84 0 01-3.58-1.58V6.69h3.58z"/></svg></a>
                <a href="https://wa.me/905456876161" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:opacity-80 transition-all" title="WhatsApp"><svg class="w-5 h-5" viewBox="0 0 24 24" fill="#25D366"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.654-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg></a>
            </div>
        </div>
        <div class="lg:pl-6">
        ...
        <div>
            ...
            <ul class="space-y-4">
                <li><span class="text-white/70 text-sm" data-kv="phone">0 545 687 61 61</span></li>
                <li><span class="text-white/70 text-sm" data-kv="email"></span></li>
                <li><span class="text-white/70 text-sm">Plevne Mahallesi Plevne Sokak No:5/a Sincan/Ankara</span></li>
            </ul>
        </div>
        <div>
    ...
    <div class="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/10 space-y-6">
        <div>
            ...
            <div class="flex flex-wrap gap-x-4 gap-y-1 text-xs text-white/60">
                ...
                <a href="/cukurambar-hali-yikama" class="hover:text-[#E0457B] transition-colors">Çukurambar Halı Yıkama</a>
                <a href="/ankara-hali-yikama" class="hover:text-[#E0457B] transition-colors">Ankara Halı Yıkama</a>
            </div>
        </div>
        <div>
