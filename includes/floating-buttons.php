<?php // LeadFlow — Floating Butonlar + WhatsApp Popup + Cookie Banner (otomatik üretildi) ?>
...
<div id="waPopup" class="fixed inset-0 z-[200] hidden">
    ...
    <div class="absolute bottom-24 right-4 left-4 sm:left-auto sm:right-6 md:right-8 sm:w-72 bg-white rounded-2xl shadow-2xl overflow-hidden" style="animation: slideIn 0.3s ease">
        <div class="bg-gradient-to-r from-[#25D366] to-[#128C7E] px-4 py-3 flex items-center justify-between">
            <span class="text-white font-bold text-sm">WhatsApp ile Yazin</span>
...
<!-- Instagram Button -->
<a href="https://www.instagram.com/hayati_bank?utm_source=qr&igsh=MXBkZHppeDhydGZzNg==" target="_blank" rel="noopener noreferrer" data-kv-href="instagram_url" id="instagramButton" title="Instagram" class="fixed right-6 md:right-8 w-12 h-12 rounded-full text-white hover:scale-110 transition-all duration-500 ease-out z-[100] flex items-center justify-center cursor-pointer group" style="bottom:8.5rem;background:radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%, #d6249f 60%, #285AEB 90%);box-shadow:0 0 24px rgba(214,36,159,0.45);">
...
<!-- Scroll to Top (CSS: head-common.php, JS: main.js) -->
<button id="scrollTopBtn" aria-label="Yukari cik">
    <svg viewBox="0 0 42 60" width="42" height="60" fill="none">
        <line x1="21" y1="56" x2="21" y2="16" stroke="#E0457B" stroke-width="2.5" stroke-linecap="round"/>
        <path d="M21 5 L13 21 L21 15 L29 21 Z" fill="#E0457B"/>
        <path d="M12 44 C12 35, 30 35, 30 44" stroke="#E0457B" stroke-width="1" fill="none" opacity="0.5"/>
    </svg>
</button>

<!-- Sticky Rezervasyon Butonu (mobil, CSS: head-common.php, JS: main.js) -->
<div id="stickyReservation">
    <a href="/#iletisim" class="btn-shimmer" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:12px 32px;border-radius:9999px;font-size:14px;font-weight:700;letter-spacing:0.05em;color:#fff;text-transform:uppercase;text-decoration:none;white-space:nowrap;box-shadow:0 4px 20px rgba(0,0,0,0.3)">
...
<!-- Cerez Banner: main.js tarafından dinamik oluşturulur -->
